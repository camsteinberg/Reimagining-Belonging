...
export default function MeaningToReality() {
  ...
  useGSAP(() => {
    ...
    const lineGroup = document.querySelector(".slide20LineGroup") as HTMLElement | null;
    const dashedLine = document.querySelector(".slide20Line--dashed") as HTMLElement | null;
    const solidLines = document.querySelectorAll(".slide20Line--solid");
    const solidUp = document.querySelector(".slide20Line--up") as HTMLElement | null;
    const solidDown = document.querySelector(".slide20Line--down") as HTMLElement | null;
  ...
  return (
    <section ref={containerRef} className="slide slide23" data-bg="">
      ...
      <img className="slide23Left" src={left23.src} alt="Community space left" />
      <img className="slide23Right" src={right23.src} alt="Community space right" />
      <img className="img21" src={img21.src} alt="Lighter spaces" />
      <img className="img22" src={img22.src} alt="Everyday life" />
    </section>
  );
}
