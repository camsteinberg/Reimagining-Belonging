          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 mt-10 aspect-[4/3] rounded-2xl overflow-hidden hidden md:block">
                <img src={researchSession} alt="Team research and planning session" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
        ...
        <section className="py-16 md:py-20 bg-sage/5">
          <div className="page-container max-w-3xl mx-auto text-center">
            <blockquote className="reveal-scale font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic">
              "Housing is not simply shelter. It is the platform that makes
              work, learning, health, savings, and ownership possible."
            </blockquote>
          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-4">
              ...
              <div className="reveal-left stagger-2 mt-10 aspect-square rounded-2xl overflow-hidden hidden md:block">
                <img src={classroom} alt="Fellowship learning session" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
            ...
            <div className="reveal-up flex gap-6 items-start">
              ...
              <div>
                <blockquote className="font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic mb-4">
                  "Most systems stop at shelter. The HCU Ladder doesn't ask 'are
                  you housed?' — it asks 'what can you do now that you're housed?'"
                </blockquote>
        ...
        <section id="robotic-fabrication" className="py-24 md:py-36">
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 mt-10 aspect-[4/3] rounded-2xl overflow-hidden hidden md:block">
                <img src={prototype} alt="Housing prototype under construction with crane" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
        ...
        <section id="the-foundation" className="py-24 md:py-36">
          <div className="page-container">
            ...
            <div className="reveal-up stagger-3 mb-14 aspect-[21/9] rounded-2xl overflow-hidden">
              <img src={fellowship} alt="Fellows planning and organizing at workstation" className="w-full h-full object-cover" loading="lazy" decoding="async" />
            </div>
        ...
        <section className="py-16 md:py-20 bg-clay/5">
          <div className="page-container max-w-3xl mx-auto">
            <div className="reveal-up flex gap-6 items-start">
              ...
              <div>
                <blockquote className="font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic mb-4">
                  "The fellowship model doesn't just build skills — it builds a
                  self-sustaining ecosystem. Graduates become instructors, and
                  instructors build the capacity of the next community."
                </blockquote>
                <p className="font-sans text-xs uppercase tracking-[0.3em] text-charcoal/40">
          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 aspect-[16/9] rounded-2xl overflow-hidden mb-8 hidden md:block">
                <img src={ranchLand} alt="Idaho ranch land — potential housing site" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
