...
export default function ClosingSequence() {
  ...
  const slide26TextRef = useRef<HTMLDivElement>(null);
  const slide27TextRef = useRef<HTMLDivElement>(null);
  const acresSpanRef = useRef<HTMLSpanElement>(null);
  ...
  return (
    <div ref={containerRef}>
      <section className="slide slide255" data-bg={finalImage.src} />

      <section className="slide slide26" data-bg={finalImage.src} data-fade="2500">
        <div
          ref={slide26TextRef}
      ...
      <section className="slide slide27" data-bg={finalImage2.src} data-fade="2500">
        <div
          ref={slide27TextRef}
