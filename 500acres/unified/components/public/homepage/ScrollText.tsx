...
export default function ScrollText() {
  return (
    <>
      <section className="slide slide2 tight-text" data-bg={sectionBg1.src}>
        <div className="slide2TextContainer">
          <div>Gen Z grows up scrolling.</div>
        </div>
      </section>

      <section className="slide slide3 tight-text" data-bg={sectionBg2.src}>
      ...
      <section className="slide slide4 tight-text" data-bg={sectionBg3.src}>
      ...
      <section className="slide slide5 tight-text" data-bg={sectionBg4.src}>
