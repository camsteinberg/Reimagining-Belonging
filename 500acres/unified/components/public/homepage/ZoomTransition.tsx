...
export default function ZoomTransition() {
  ...
  useGSAP(() => {
    const slide6BottomText = document.querySelector(".slide6BottomText") as HTMLElement | null;
    const slide6Stage7 = document.querySelector(".slide6Stage7") as HTMLElement | null;
    const slide7Overlay = document.querySelector(".slide7BgOverlay") as HTMLElement | null;
    const slide7Text = document.querySelector(".slide7TextContainer") as HTMLElement | null;
    const slide8El = document.querySelector(".slide8") as HTMLElement | null;
  ...
  return (
    <section ref={containerRef} className="slide slide6 tight-text" data-bg={sectionBg5.src}>
