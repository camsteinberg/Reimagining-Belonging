...
const TOC_SECTIONS = [
  ...
  { id: "the-crisis", label: "The Crisis" },
  { id: "housing-capacity", label: "Housing Capacity" },
  { id: "the-hypothesis", label: "The Hypothesis" },
  { id: "hcu-ladder", label: "The HCU Ladder" },
  { id: "nesting-pods", label: "Nesting Pods" },
  { id: "robotic-fabrication", label: "Robotic Fabrication" },
  { id: "the-foundation", label: "The Foundation" },
  { id: "opportunity-zones", label: "Opportunity Zones" },
  { id: "business-model", label: "Business Model" },
  { id: "accountability", label: "Accountability" },
  { id: "policy-tailwinds", label: "Policy Context" },
  ...
  return (
    <div ref={ref} className="inner-page grain bg-cream min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-[65vh] flex flex-col justify-end pb-14 md:pb-20 lg:pb-28">
        <img src={heroBarndo.src} alt="" className="absolute inset-0 w-full h-full object-cover opacity-10" loading="lazy" decoding="async" />
      ...
      <div className="lg:hidden sticky top-0 z-40 bg-cream/95 backdrop-blur-sm border-b border-charcoal/10">
        <div className="page-container">
          ...
          >
            <span className="font-sans text-xs uppercase tracking-[0.3em] text-charcoal/60">
              Table of Contents
            </span>
            <span
            ...
            <nav className="pb-4 space-y-1" aria-label="Table of contents">
              {TOC_SECTIONS.map((s) => (
                <button
                  ...
                  className={`block w-full text-left px-3 py-2 rounded-lg font-sans text-sm transition-colors duration-200 ${
                    activeSection === s.id
      ...
      {/* Main content area with desktop sidebar TOC */}
      <div className="relative">
        {/* Desktop TOC sidebar -- sticky */}
        <aside className="hidden lg:block fixed top-32 left-[max(1rem,calc((100vw-1400px)/2-10px))] w-48 z-30" aria-label="Table of contents">
          <nav className="space-y-1">
            <p className="font-sans text-xs uppercase tracking-[0.3em] text-charcoal/40 mb-4 px-3">
              Contents
            </p>
            {TOC_SECTIONS.map((s) => (
              <button
                key={s.id}
                onClick={() => scrollToId(s.id)}
                className={`block w-full text-left px-3 py-1.5 rounded-lg font-sans text-xs transition-all duration-200 ${
                  activeSection === s.id
                    ? "bg-forest/10 text-forest font-medium translate-x-1"
          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 mt-10 aspect-[4/3] rounded-2xl overflow-hidden hidden md:block">
                <img src={researchSession.src} alt="Team research and planning session" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
        ...
        {/* Pull Quote: Visual Break #1 */}
        <section className="py-16 md:py-20 bg-sage/5">
          <div className="page-container max-w-3xl mx-auto text-center">
            <blockquote className="reveal-scale font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic">
              &ldquo;Housing is not simply shelter. It is the platform that makes
              work, learning, health, savings, and ownership possible.&rdquo;
            </blockquote>
            <p className="reveal-up stagger-1 font-sans text-xs uppercase tracking-[0.3em] text-charcoal/40 mt-6">
        ...
        <section id="the-crisis" className="relative py-16 md:py-28 lg:py-40 bg-charcoal diagonal-top overflow-hidden">
          <img src={firepit.src} alt="" className="absolute inset-0 w-full h-full object-cover opacity-15" loading="lazy" decoding="async" />
          ...
          <div className="page-container relative z-10 max-w-4xl mx-auto text-center">
            ...
            <blockquote className="reveal-scale font-serif text-2xl md:text-3xl lg:text-4xl text-cream leading-[1.5] font-bold italic mb-10">
              &ldquo;Workers in wealthy resort towns sleep in their cars because rent
              is out of reach — even while working full time. They are not
              outside the workforce. They are the workforce.&rdquo;
            </blockquote>
          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-4">
              ...
              <div className="reveal-left stagger-2 mt-10 aspect-square rounded-2xl overflow-hidden hidden md:block">
                <img src={classroom.src} alt="Fellowship learning session" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col gap-0">
                {HCU_TIERS.map((tier, i) => (
                  <div
                    key={tier.tier}
                    className={`reveal-up stagger-${(i % 4) + 1} relative`}
                  >
                    {i > 0 && (
                      <div
                        className="hidden md:block absolute -top-6 bg-charcoal/15"
                        style={{ left: `${(i - 1) * 4 + 2}%`, width: "2px", height: "24px" }}
                        aria-hidden="true"
                      />
                    )}
                    {i > 0 && (
                      <div
                        className="hidden md:block absolute top-6 bg-charcoal/15"
                        style={{ left: `${(i - 1) * 4 + 2}%`, width: `${4}%`, height: "2px" }}
                        aria-hidden="true"
                      />
                    )}
                    <div
                      className={`${tier.color} ${tier.textColor} rounded-2xl p-6 md:p-8 transition-transform duration-500 hover:-translate-y-1 hover:shadow-xl mb-3`}
                      style={{
                        marginLeft: `${i * 4}%`,
                        marginRight: `${(4 - i) * 4}%`,
                      }}
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                        <div className="flex items-center gap-4 shrink-0">
                          <div className="w-10 h-10 rounded-full bg-white/15 flex items-center justify-center">
                            <span className="font-sans text-sm font-bold">{tier.step}</span>
                          </div>
                          <div>
                            <span className="font-sans text-xs uppercase tracking-widest opacity-60 block">
                              {tier.tier}
                            </span>
              ...
              <div className="flex justify-end mt-6 mr-[4%]" aria-hidden="true">
                <div className="flex items-center gap-2 text-charcoal/30">
                  <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M10 16V4M10 4l-4 4M10 4l4 4" />
                  </svg>
                  <span className="font-sans text-xs uppercase tracking-widest">Increasing capacity</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Pull Quote: Visual Break #2 */}
        <section className="py-16 md:py-20 bg-amber/5">
          <div className="page-container max-w-3xl mx-auto">
            <div className="reveal-up flex gap-6 items-start">
              <div className="w-1 shrink-0 self-stretch bg-amber/40 rounded-full" aria-hidden="true" />
              <div>
                <blockquote className="font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic mb-4">
                  &ldquo;Most systems stop at shelter. The HCU Ladder doesn&apos;t ask &apos;are
                  you housed?&apos; — it asks &apos;what can you do now that you&apos;re housed?&apos;&rdquo;
                </blockquote>
        ...
        {/* Stat Block: Visual Break #3 */}
        <section className="py-16 md:py-20 bg-forest/5">
          <div className="page-container">
            <div className="reveal-up grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
              <div>
                <span className="block font-serif text-4xl md:text-5xl font-bold text-forest mb-2">20-50%</span>
                <span className="font-sans text-xs uppercase tracking-widest text-charcoal/50">Faster timelines</span>
              </div>
              <div>
                <span className="block font-serif text-4xl md:text-5xl font-bold text-forest mb-2">15%</span>
                <span className="font-sans text-xs uppercase tracking-widest text-charcoal/50">Less material waste</span>
              </div>
              <div>
                <span className="block font-serif text-4xl md:text-5xl font-bold text-forest mb-2">19%</span>
                <span className="font-sans text-xs uppercase tracking-widest text-charcoal/50">Lower emissions</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="robotic-fabrication" className="py-16 md:py-24 lg:py-36">
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 mt-10 aspect-[4/3] rounded-2xl overflow-hidden hidden md:block">
                <img src={prototype.src} alt="Housing prototype under construction with crane" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            </div>
        ...
        <section className="relative py-16 md:py-28 lg:py-40 bg-charcoal diagonal-top diagonal-bottom overflow-hidden">
          <img src={workbench.src} alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" loading="lazy" decoding="async" />
          <div className="absolute inset-0 bg-charcoal/70" />
          <div className="page-container relative z-10 text-center max-w-4xl mx-auto">
            <blockquote className="reveal-scale font-serif text-2xl md:text-4xl lg:text-5xl text-cream leading-[1.5] font-bold italic">
              &ldquo;We don&apos;t just build housing. We build builders — and builders
              build the next one.&rdquo;
            </blockquote>
          </div>
        </section>
        ...
        <section id="the-foundation" className="py-16 md:py-24 lg:py-36">
          <div className="page-container">
            ...
            <div className="reveal-up stagger-3 mb-14 aspect-[21/9] rounded-2xl overflow-hidden">
              <img src={fellowship.src} alt="Fellows planning and organizing at workstation" className="w-full h-full object-cover" loading="lazy" decoding="async" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14">
              ...
              <div className="reveal-up stagger-1 p-10 md:p-14 rounded-2xl border bg-forest/10 border-forest/30">
                ...
                <div className="mt-8 flex items-center gap-2 text-forest/40" aria-hidden="true">
                  <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M17 10a7 7 0 11-2-5" />
                    <path d="M15 2v4h4" />
                  </svg>
                  <span className="font-sans text-xs uppercase tracking-widest">Repeating cycle</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Pull Quote: Visual Break #4 */}
        <section className="py-16 md:py-20 bg-clay/5">
          <div className="page-container max-w-3xl mx-auto">
            <div className="reveal-up flex gap-6 items-start">
              <div className="w-1 shrink-0 self-stretch bg-clay/40 rounded-full" aria-hidden="true" />
              <div>
                <blockquote className="font-serif text-xl md:text-2xl text-charcoal/80 leading-[1.6] italic mb-4">
                  &ldquo;The fellowship model doesn&apos;t just build skills — it builds a
                  self-sustaining ecosystem. Graduates become instructors, and
                  instructors build the capacity of the next community.&rdquo;
                </blockquote>
                <p className="font-sans text-xs uppercase tracking-[0.3em] text-charcoal/40">
          ...
          <div className="page-container grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
            <div className="md:col-span-5">
              ...
              <div className="reveal-left stagger-3 aspect-[16/9] rounded-2xl overflow-hidden mb-8 hidden md:block">
                <img src={ranchLand.src} alt="Idaho ranch land — potential housing site" className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
